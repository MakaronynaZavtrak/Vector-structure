...
#include <string>
using namespace std;
	//объект-вектор - это три координаты
	//один объект структуры - это вектор
	//добавить функции поворта на угол альфа, т.е. совместить со второй задачей
	//вынести методыструктуры в отдельный functions.cpp
int main()
{
	int c[3]{ 3,1, 2 };
	int b[3]{ 2,5,2 };
